...
async def start(update, context): # 当用户输入/start时，返回文本
    ...
    message = (
        f"Hi `{user.username}` ! I am an Assistant, a large language model  I will do my best to help answer your questions.\n\n"
    )
...
async def post_init(application: Application) -> None:
    ...
    description = (
        "I am an Assistant, a large language model  I will do my best to help answer your questions."
    )
